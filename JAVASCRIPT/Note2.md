...
```js
console.log(this);  // window (in browser) or {} (in Node.js module)
```
...
person.greet();          // "Sahithi" — this = person
...
const Sahithi = new Person("Sahithi");
Sahithi.greet();  // "Hi, I am Sahithi"
```
...
| --- | --- |
|Regular function call fn() | global object (or undefined in strict mode) |
...
boundGreet();  // "Hi, I am Sahithi"
boundGreet();  // "Hi, I am Sahithi"  — this is permanently locked
```
...
```js
// Arrow function as an object method — PROBLEM
const person = {
  name: "Sahithi",
  greet: () => {
...
```js
// 1. Regular function call — global or undefined
